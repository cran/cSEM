...
1. **Get the essential**: no estimator or approach works without data and a description
   ...
   [RStudio](https://rstudio.com), data import and data transformation 
...
the [Rstudio Cheat sheet webpage](https://rstudio.com/resources/cheatsheets/),
...
1. A `data.frame` or `tibble` with column names matching the indicator names used
   ...
   **Example:**
   ...
   `imag1`, `imag2`. More one model specificaiton below.
...
The current version 0.1.0 available on CRAN does not 
